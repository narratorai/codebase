...
from core.v4.query_runner import TYPE_STRING, BaseHTTPQueryRunner
        ...
        if isinstance(v, dict):
            ...
            if len(member_names) > 0:
                ...
                for member_name in member_names:
                    listValues = []
                    for listItem in v:
                        if isinstance(listItem, dict) and member_name in listItem:
...
class JiraJQL(BaseHTTPQueryRunner):
    ...
    password_title = "API Token"  # noqa: S105
