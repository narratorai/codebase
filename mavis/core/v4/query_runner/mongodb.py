...
from core.v4.utils import JSONEncoder, json_dumps, json_loads
from core.v4.utils.human_time import parse_human_time
...
class MongoDB(BaseQueryRunner):
    ...
    def _get_collection_fields(self, db, collection_name):
        ...
        # to have the same fields as another document in the collection its a bit hard to
