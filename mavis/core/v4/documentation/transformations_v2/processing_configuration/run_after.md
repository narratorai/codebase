...
Keep in mind that Transformations use 2 different schedules. All Materialized Views process on the "Run Async Transformation" so if the transformation that you are running after is on a different schedule it will not work.
