...
WHERE
	(
		SAFE_CAST( stg__activity_stream.customer AS STRING) = LOWER(CASE WHEN a.anonymous_customer_id in ("None", "none", "", " ", "null", "NULL", "nil") THEN NULL ELSE a.anonymous_customer_id END)  AND
