...
SELECT
	*
	, RATIO_TO_REPORT(total_started_pro_subscription_rows) OVER (PARTITION BY month_of_timestamp) AS "percent_of_started_session"
FROM (
	SELECT
...
ORDER BY month_of_timestamp DESC, last_touch_channel ASC
