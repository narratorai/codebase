...
SELECT
	...
	, AVG(1.0000*rd.did_started_session_between) AS conversion_rate_to_started_session_between
	, AVG(1.0000*rd.days_to_started_session) AS average_days_to_started_session
