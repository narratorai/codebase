...
export const RELATIONSHIP_CONTEXT = {
  description:
    "This temporal join finds the LAST time the join activity (<%= appendActivityName %>) happened before the customer's first primary activity (<%= cohortActivityName %>).",
  link: 'https://docs.narrator.ai/docs/relationships#last-before',
  common_uses: [
    {
      key: 1,
      text: "Last Touch Attribution: Enrich your dataset with the ad source from the last session of a customer's first order.",
    },
    {
      key: 2,
      text: 'Last page before first ticket: Understand what leads your customer to submit their first ticket.',
    },
  ],
}
