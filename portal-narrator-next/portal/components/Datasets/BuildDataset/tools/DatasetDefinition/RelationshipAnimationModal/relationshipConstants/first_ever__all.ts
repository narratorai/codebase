...
export const RELATIONSHIP_CONTEXT = {
  description:
    'This temporal join adds the FIRST time the join activity (<%= appendActivityName %>) happened, regardless of when the primary activity (<%= cohortActivityName %>) occurred.',
  link: 'https://docs.narrator.ai/docs/relationships#first-ever',
  common_uses: [
    { key: 1, text: 'Segment your dataset by the first ad source (first touch attribution)' },
    { key: 2, text: 'Segment your dataset by the first time they ordered (split by customer tenure)' },
    { key: 3, text: 'Segment your dataset by the date of the first subscription (retention curves)' },
  ],
}
...
export const RELATIONSHIP_ANIMATION_STEPS = [
  ...
  },
  {
    ...
    customerJourney: {
      show: true,
      relationshipTitles: [{ title: '**First** Ever', start: null, end: null, showNull: false }],
      customer: [
        { type: 'cohort', ignored: true },
        { type: 'append', ignored: false, leftMargin: true, highlighted: true },
        { type: 'append', ignored: false, leftMargin: true, crossedOut: true, bottomMargin: true },
