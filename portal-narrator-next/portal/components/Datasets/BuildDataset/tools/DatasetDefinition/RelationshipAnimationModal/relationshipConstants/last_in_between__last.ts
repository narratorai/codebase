...
export const RELATIONSHIP_ANIMATION_STEPS = [
...

  {
    ...
    customerJourney: {
      show: true,
      relationshipTitles: [{ title: 'Last **In Between**', start: 3, end: null }],
      customer: [
        { type: 'append', ignored: true, section: 1 },
        { type: 'append', ignored: true, section: 1 },
  ...
  {
    title: 'Last In Between - Choose the FIRST <%= appendActivityName %> from those activities',
    customerName: 'Britt',
    table: {
      show: true,
      focusCustomer: true,
  ...
  },
  {
    ...
    customerJourney: {
      ...
      customer: [
        { type: 'append', ignored: true, section: 1 },
        { type: 'append', ignored: true, section: 1 },
        { type: 'cohort', ignored: false, section: 1, crossedOut: true, bottomMargin: true },
        { type: 'cohort', ignored: true, section: 2, highlighted: true },
      ],
    },
  },
