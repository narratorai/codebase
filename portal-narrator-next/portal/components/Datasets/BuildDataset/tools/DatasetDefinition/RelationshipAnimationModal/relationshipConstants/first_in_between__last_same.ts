...
export const RELATIONSHIP_ANIMATION_STEPS = [
  ...
  {
    title: '"First In Between" - Find the next <%= appendActivityName %>',
    table: {
      show: true,
      cohort: [
        { type: 'cohort', ignored: false },
    ...
    customerJourney: {
      show: true,
      relationshipTitles: [{ title: '**First In Between** (next)', start: 2, end: null }],
      customer: [
  ...
  },
  {
    ...
    customerJourney: {
      show: true,
      relationshipTitles: [{ title: '**First In Between** (next)', start: 2, end: null, showNull: true }],
      customer: [
        { type: 'cohort', ignored: true, bottomMargin: true },
        { type: 'cohort', ignored: true, bottomMargin: true },
        { type: 'cohort', ignored: false, highlighted: true },
