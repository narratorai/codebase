...
export const RELATIONSHIP_CONTEXT = {
  description:
    'This temporal join adds the last time the join activity (<%= appendActivityName %>) happened for each primary activity(<%= cohortActivityName %>).',
  link: 'https://docs.narrator.ai/docs/relationships#last-ever',
  common_uses: [{ key: 1, text: "Add the last submitted ticket to customer's first sign up" }],
}
