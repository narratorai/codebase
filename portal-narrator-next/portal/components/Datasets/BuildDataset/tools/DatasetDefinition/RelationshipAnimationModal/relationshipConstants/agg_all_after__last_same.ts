...
export const RELATIONSHIP_ANIMATION_STEPS = [
  ...
  },
  {
    ...
    customerJourney: {
      show: true,
      relationshipTitles: [{ title: 'Aggregate **After**', start: 2, end: null }],
      customer: [
  ...
  {
    title:
      'There are no <%= appendActivityName %> activities AFTER, so a 0 value is added to the corresponding activity in the dataset',
    table: {
      show: true,
      cohort: [
        { type: 'cohort', ignored: false },
    ...
    customerJourney: {
      show: true,
      relationshipTitles: [{ title: '**Aggregate** After', start: 2, end: null, aggFunction: true }],
      customer: [
        { type: 'cohort', ignored: true, bottomMargin: true },
        { type: 'cohort', ignored: true, bottomMargin: true },
        { type: 'cohort', ignored: false, highlighted: true },
