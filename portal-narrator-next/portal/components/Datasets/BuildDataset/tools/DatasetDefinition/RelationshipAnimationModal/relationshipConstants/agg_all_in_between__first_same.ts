...
export const RELATIONSHIP_CONTEXT = {
  description:
    "This temporal join aggregates all the join activities (<%= appendActivityName %>) that happened after a customer's first primary activity (<%= cohortActivityName %>).",
  link: 'https://docs.narrator.ai/docs/relationships#agg-in-between',
  common_uses: [
    { key: 1, text: 'Calculate all paid invoices after first sign up' },
    { key: 2, text: 'Count the number of tickets after the first viewed FAQ page' },
  ],
}
