...
export const RELATIONSHIP_ANIMATION_STEPS = [
  ...
  },
  {
    ...
    customerJourney: {
      ...
      customer: [
        ...
        { type: 'cohort', ignored: false, section: 3, bottomMargin: true, crossedOut: true },
      ],
    },
  },
  {
    ...
    customerJourney: {
      ...
      customer: [
        { type: 'cohort', ignored: false, section: 1, highlighted: true },
        { type: 'cohort', ignored: true, section: 1, crossedOut: true },
        ...
        { type: 'cohort', ignored: true, section: 3, bottomMargin: true, crossedOut: true },
      ],
    },
  },
  {
  ...
  {
    title: 'After - Find all <%= appendActivityName %> activities that happened AFTER the <%= cohortActivityName %>',
    customerName: 'Britt',
    table: {
      show: true,
      focusCustomer: true,
