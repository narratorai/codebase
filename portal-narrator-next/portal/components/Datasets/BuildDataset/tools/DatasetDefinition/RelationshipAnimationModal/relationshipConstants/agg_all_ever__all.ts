...
export const RELATIONSHIP_CONTEXT = {
  description:
    'This temporal join aggregates all the join activities (<%= appendActivityName %> activities) that EVER happened, regardless of when the primary activity (<%= cohortActivityName %>) occurred. Then the aggregate value (SUM, COUNT, MAX, etc) is appended to the dataset.',
  link: 'https://docs.narrator.ai/docs/relationships#aggregate-ever',
  common_uses: [
    { key: 1, text: 'Enrich your dataset with the SUM of the revenue from all Purchased Products (LTV)' },
    { key: 2, text: 'Enrich your dataset with the COUNT of all Paid Invoices (Total active months)' },
    { key: 3, text: 'Enrich your dataset with the COUNT of all Tickets (How many tickets did this customer submit?)' },
  ],
}
  ...
  },
  {
    ...
    customerJourney: {
      ...
      customer: [
        { type: 'cohort', ignored: true },
        { type: 'append', ignored: false, aggFunction: true },
        { type: 'append', ignored: false, aggFunction: true, bottomMargin: true },
        { type: 'cohort', ignored: false },
        { type: 'append', ignored: false, aggFunction: true, bottomMargin: true },
        { type: 'cohort', ignored: false, bottomMargin: true },
        { type: 'cohort', ignored: false },
