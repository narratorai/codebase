...
export const RELATIONSHIP_CONTEXT = {
  description: 'This temporal join aggregates all the join activities (<%= appendActivityName %>) happened ever.',
  link: 'https://docs.narrator.ai/docs/relationships#agg-all-ever',
  common_uses: [{ key: 1, text: 'Add the total paid invoices to Last ever subscription.' }],
}
