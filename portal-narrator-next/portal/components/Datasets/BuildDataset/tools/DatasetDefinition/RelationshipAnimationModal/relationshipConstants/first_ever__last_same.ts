...
export const RELATIONSHIP_CONTEXT = {
  description:
    'This temporal join adds the FIRST join activity (<%= appendActivityName %>) to each row in your dataset.',
  link: 'https://docs.narrator.ai/docs/relationships#first-ever',
  common_uses: [{ key: 1, text: "Add first ad source to your customer's last sign up" }],
}
