...
type Props = Omit<HeadlessSelectProps, 'as' | 'className'>

const Select = ({ multiple, ...props }: Props, ref: SelectRef) => (
  <span
    className={clsx(
      // Basic layout
      ...
      'dark:before:hidden',
      // Focus ring
      'after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent after:has-[[data-focus]]:ring-2 after:has-[[data-focus]]:ring-indigo-500',
      // Disabled state
