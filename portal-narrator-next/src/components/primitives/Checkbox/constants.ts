...
export const ICON_COLORS = {
  amber: '[--checkbox-check:theme(colors.amber.500)]',
  blue: '[--checkbox-check:theme(colors.blue.600)]',
  cyan: '[--checkbox-check:theme(colors.cyan.400)]',
  dark: '[--checkbox-check:theme(colors.zinc.900)]',
  'dark/white': ['[--checkbox-check:theme(colors.zinc.900)]', 'dark:[--checkbox-check:theme(colors.white)]'],
  'dark/zinc': ['[--checkbox-check:theme(colors.zinc.900)]', 'dark:[--checkbox-check:theme(colors.zinc.600)]'],
  emerald: '[--checkbox-check:theme(colors.emerald.600)]',
  fuchsia: '[--checkbox-check:theme(colors.fuchsia.500)]',
  green: '[--checkbox-check:theme(colors.green.600)]',
  indigo: '[--checkbox-check:theme(colors.indigo.500)]',
  lime: '[--checkbox-check:theme(colors.lime.400)]',
  orange: '[--checkbox-check:theme(colors.orange.500)]',
  pink: '[--checkbox-check:theme(colors.pink.500)]',
  purple: '[--checkbox-check:theme(colors.purple.500)]',
  red: '[--checkbox-check:theme(colors.red.600)]',
  rose: '[--checkbox-check:theme(colors.rose.500)]',
  sky: '[--checkbox-check:theme(colors.sky.500)]',
  teal: '[--checkbox-check:theme(colors.teal.600)]',
  violet: '[--checkbox-check:theme(colors.violet.500)]',
  white: '[--checkbox-check:theme(colors.white)]',
  yellow: '[--checkbox-check:theme(colors.yellow.400)]',
  zinc: '[--checkbox-check:theme(colors.zinc.600)]',
}
