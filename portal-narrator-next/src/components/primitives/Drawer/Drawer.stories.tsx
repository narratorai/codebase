...
import { Drawer, DrawerActions, DrawerBody, DrawerCloseButton, DrawerHeader, DrawerTitle } from '.'
  ...
  return (
    <>
      ...
      <Drawer {...props} onClose={setIsOpen} open={isOpen}>
        <DrawerHeader>
          <DrawerTitle>Dialog Title Dialog Title Dialog Title Dialog Title Dialog Title</DrawerTitle>
          <DrawerCloseButton />
        </DrawerHeader>
